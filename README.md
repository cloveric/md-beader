...
<div align="center">
  <img src="docs/hero.svg" alt="Markdown Studio" width="100%" />
...
Markdown Studio 不是“在线文档工具”的桌面壳，而是一套针对本地 Markdown 使用习惯优化的工作台：
...
cargo build --release
.\target\release\markdown_reader.exe
```

### 2. 带文件启动

```powershell
.\target\release\markdown_reader.exe C:\path\to\README.md
```
